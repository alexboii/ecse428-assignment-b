Feature: Sending Email with Image Attachment
    ...
    Scenario Outline: Send email with file image attachment
        ...
        Examples:
            ...
            | rabbit_that_sobs_sad@gmail.com | Small Transparent Picture         | image_small_transparent.png |
            | sobbingrabbit_1337@gmail.com   | Image White Background            | image_white_background.jpg  |
